          ...
          <div className={styles.contentCard}>
            ...
            <section id="third-party-infra" className={styles.section}>
              ...
              <ul className={styles.list}>
                ...
                <li className={styles.listItem}>
                  <strong>Payment Processors:</strong> Stripe, Payoneer, Wise (secure, PCI-compliant payment gateways).
                </li>
                <li className={styles.listItem}>
            ...
            <section id="contact-dpo" className={styles.section}>
              ...
              <div className={styles.contactBox}>
                ...
                <p><strong>Department:</strong> Privacy & Compliance Team</p>
                <p><strong>Email:</strong> <a href="mailto:privacy@raydrim.com" className={styles.contactLink}>privacy@raydrim.com</a></p>
