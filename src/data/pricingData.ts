...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    price: '$999',
    period: 'one-time / project',
    description: 'Perfect for established small businesses and startups needing a complete, multi-page web platform or a simple mobile app.',
    timeline: '1 – 2 Weeks Delivery',
    idealFor: 'Growing businesses, multi-page sites & simple mobile apps',
    popular: false,
    ctaText: 'Launch Starter ($999)',
    features: [
      'Bespoke Next.js Web Architecture',
  ...
  },
  {
    ...
    price: '$2,999',
    period: 'one-time / project',
    description: 'Full-featured tier for custom web applications, Shopify e-commerce stores, or cross-platform mobile apps for Android & iOS.',
    timeline: '2 – 4 Weeks Delivery',
    idealFor: 'Web apps, Shopify stores & cross-platform mobile apps',
    popular: true,
    badge: 'Most Popular',
  ...
  },
  {
    ...
    description: 'Tailored for large-scale apps, complex backends, native mobile apps (iOS/Android/PC), AI workflows, and multi-platform deployment.',
    timeline: 'Custom Agile Sprints',
    idealFor: 'Complex platforms, native apps, AI & multi-platform deployment',
    popular: false,
    badge: 'Custom Scope',
    ...
    features: [
      ...
      'Native Mobile Apps (Swift / Kotlin / React Native)',
      'Desktop App Development (Electron / PC / Mac)',
      'Google Play Store, App Store & Windows Store Publishing',
      'In-App Purchases & Subscription Monetization',
