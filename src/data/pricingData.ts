...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    description: '1-on-1 technical discovery & architecture scoping session for your mobile app. We scope features, screens, backend integrations, and prepare a complete build roadmap before writing code.',
    timeline: '1-Day Delivery · Architecture Spec',
    idealFor: 'Founders & startups wanting clarity before committing to a full app build',
    popular: false,
    badge: 'Scoping & Strategy',
    ctaText: 'Book Planning Session ($130)',
    features: [
      '1-on-1 Architecture & Scope Session',
      'Feature Breakdown & Screen Flow Mapping',
      'API & Backend Integration Strategy',
      'Written Technical Spec & Roadmap',
      'Direct Advice Before Committing to Code',
    ],
  },
  {
