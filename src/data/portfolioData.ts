...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  {
    ...
    description: 'A modern, conversion-focused Shopify storefront built for timepiece collections. Features high-contrast hero visuals, mobile-optimized checkout, and streamlined catalog navigation. (Storefront Password: watch)',
    ...
    keyResults: [
      'Built and launched responsive Shopify storefront at watchie-3.myshopify.com (Password: watch)',
